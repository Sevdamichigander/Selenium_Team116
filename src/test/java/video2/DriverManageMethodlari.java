...
public class DriverManageMethodlari {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(driver.manage().window().getSize()); // (1552, 832) pixel
        System.out.println(driver.manage().window().getSize().height); // 832

            // 1-B driver.manage().window().getPosition() --> icinde oldugu sayfanin pixel olarak konumunu döndürür. Acilan pencerenin hangi pixel parcasindan basladigini gosterir.
